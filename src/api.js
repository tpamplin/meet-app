...
const checkToken = async (accessToken) => {
    const fetchUrl = `https://www.googleapis.com/oauth2/v1/tokeninfo?access_token=${accessToken}`;
...
const getToken = async (code) => {
    ...
    const getTokenUrl = "https://mo0ypn4rkf.execute-api.us-east-2.amazonaws.com/dev/api/token" + "/" + encodeCode;
